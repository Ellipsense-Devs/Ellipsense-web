...
const Services = () => {
  return (
    <div>
      ...
      <div className="group overflow-hidden bg-black transition-all duration-800">
      ...
      <div className="group overflow-hidden bg-gradient-to-r from-purple-700 via-purple-500 to-pink-500 transition-all duration-800">
        <div className="max-w-7xl mx-auto px-4 text-justify py-20">
      ...
      <div className="group overflow-hidden bg-gray-100 transition-all duration-800">
        <div className="max-w-7xl mx-auto px-4 text-justify py-20">
      ...
      <div className="group overflow-hidden bg-gradient-to-r from-purple-600 via-pink-500 to-yellow-300 transition-all duration-800">
        <div className="max-w-7xl mx-auto px-4 text-justify py-20">
          <h2 className="text-5xl font-bold text-white">MANAGED IT SUPPORT</h2>
          <p className="max-h-0 max-w-2xl overflow-hidden transition-all duration-800 group-hover:max-h-48 mt-4 text-lg text-white">
